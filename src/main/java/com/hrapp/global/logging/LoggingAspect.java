package com.hrapp.global.logging;
...
public class LoggingAspect {
	 ...
	 */
	@Pointcut("within(com.hrapp.global.repository..*)" + " || within(com.hrapp.global.service..*)"
			+ " || within(com.hrapp.global.controller..*)")
	...
	public void logAfterThrowing(JoinPoint joinPoint, Throwable e) {
		if (env.acceptsProfiles(Profiles.of("dev"))) { // تفعيل فقط في بيئة التطوير
